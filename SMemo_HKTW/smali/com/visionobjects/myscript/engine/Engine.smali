...
.method static constructor <clinit>()V
    ...
    invoke-direct {v2, v5, v8, v6}, Lcom/visionobjects/myscript/engine/Version;-><init>(III)V
    ...
    invoke-direct {v0, v5, v6, v6}, Lcom/visionobjects/myscript/engine/Version;-><init>(III)V
    ...
    invoke-direct {v1, v2, v7, v3}, Lcom/visionobjects/myscript/engine/Version;-><init>(III)V
    ...
    invoke-virtual {v3, v4}, Ljava/util/jar/Manifest;->getAttributes(Ljava/lang/String;)Ljava/util/jar/Attributes;
    ...
    invoke-static {v3}, Lcom/visionobjects/myscript/engine/Version;->valueOf(Ljava/lang/String;)Lcom/visionobjects/myscript/engine/Version;
    :try_end_2
...
.method private static final getManifestURL()Ljava/net/URL;
    ...
    sget-object v1, Lcom/visionobjects/myscript/engine/Engine;->class$com$visionobjects$myscript$engine$Engine:Ljava/lang/Class;

    if-nez v1, :cond_1

    const-string v1, "com.visionobjects.myscript.engine.Engine"

    invoke-static {v1}, Lcom/visionobjects/myscript/engine/Engine;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v1

    sput-object v1, Lcom/visionobjects/myscript/engine/Engine;->class$com$visionobjects$myscript$engine$Engine:Ljava/lang/Class;
    ...
    sget-object v2, Lcom/visionobjects/myscript/engine/Engine;->class$com$visionobjects$myscript$engine$Engine:Ljava/lang/Class;

    if-nez v2, :cond_2

    const-string v2, "com.visionobjects.myscript.engine.Engine"

    invoke-static {v2}, Lcom/visionobjects/myscript/engine/Engine;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v2

    sput-object v2, Lcom/visionobjects/myscript/engine/Engine;->class$com$visionobjects$myscript$engine$Engine:Ljava/lang/Class;
