...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$8500(Landroid/webkit/WebView;)Landroid/content/Context;
    ...
    #getter for: Landroid/view/View;->mContext:Landroid/content/Context;
    invoke-static {v2}, Landroid/webkit/WebView;->access$8600(Landroid/webkit/WebView;)Landroid/content/Context;
    ...
    invoke-static {v2, v3, v13, v4}, Landroid/webkit/WebView;->access$8700(Landroid/webkit/WebView;ILjava/lang/String;Z)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$8800(Landroid/webkit/WebView;)Landroid/webkit/WebViewCore$DrawData;
    ...
    #getter for: Landroid/webkit/WebView;->mDelaySetPicture:Landroid/webkit/WebViewCore$DrawData;
    invoke-static {v3}, Landroid/webkit/WebView;->access$8800(Landroid/webkit/WebView;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$8802(Landroid/webkit/WebView;Landroid/webkit/WebViewCore$DrawData;)Landroid/webkit/WebViewCore$DrawData;
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$9000(IZ)V
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$9100(Landroid/webkit/WebView;)I
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$9700(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v3}, Landroid/webkit/WebView;->access$9800(Landroid/webkit/WebView;)Ljava/lang/String;
    ...
    invoke-static {v4}, Landroid/webkit/WebView;->access$9900(Landroid/webkit/WebView;)I

    move-result v4

    #calls: Landroid/webkit/WebView;->nativeGetNodeBounds(Ljava/lang/String;I)Landroid/graphics/Rect;
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$10000(Landroid/webkit/WebView;Ljava/lang/String;I)Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v3}, Landroid/webkit/WebView;->access$10100(Landroid/webkit/WebView;Landroid/graphics/Rect;Z)V
    ...
    invoke-static {v2, v3, v4, v5, v6}, Landroid/webkit/WebView;->access$10200(Landroid/webkit/WebView;IIII)V
    ...
    invoke-static {v3, v2}, Landroid/webkit/WebView;->access$10502(Landroid/webkit/WebView;Z)Z
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$10600(Landroid/webkit/WebView;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$10700(Landroid/webkit/WebView;)Z
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$10800(Landroid/webkit/WebView;)Landroid/webkit/FindActionModeCallback;
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$11000(Landroid/webkit/WebView;IZ)Z
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$11100(Landroid/webkit/WebView;II)V
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$11200(Landroid/webkit/WebView;)Landroid/webkit/HTML5VideoViewProxy;
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$11300(Landroid/webkit/WebView;)V
    ...
    #getter for: Landroid/view/View;->mScrollX:I
    invoke-static {v2}, Landroid/webkit/WebView;->access$11400(Landroid/webkit/WebView;)I
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$11902(Landroid/webkit/WebView;I)I
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$12000(Landroid/webkit/WebView;)Landroid/webkit/AccessibilityInjector;
    ...
    invoke-static {v2, v0}, Landroid/webkit/WebView;->access$12100(Landroid/webkit/WebView;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, v3, v4}, Landroid/webkit/WebView;->access$12200(Landroid/webkit/WebView;II)V
    ...
    invoke-static {v3, v2}, Landroid/webkit/WebView;->access$12300(Landroid/webkit/WebView;Landroid/webkit/WebViewCore$SelectionCopiedData;)V
    ...
    invoke-static {v2, v3}, Landroid/webkit/WebView;->access$12402(Landroid/webkit/WebView;I)I
    ...
    iget-object v2, v2, Landroid/webkit/WebView;->mMagnifier:Landroid/webkit/WebMagnifier;
    ...
    invoke-static {v2}, Landroid/webkit/WebView;->access$12500(Landroid/webkit/WebView;)V
