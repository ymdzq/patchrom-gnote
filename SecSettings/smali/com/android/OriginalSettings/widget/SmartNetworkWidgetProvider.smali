.class public Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;
...
.method static constructor <clinit>()V
    ...
    const-string v2, "com.android.OriginalSettings.widget.SmartNetworkWidgetProvider"

    invoke-direct {v0, v1, v2}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    sput-object v0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->THIS_APPWIDGET:Landroid/content/ComponentName;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mGuideDialog:Landroid/app/AlertDialog;

    .line 56
    new-instance v0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider$1;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider$1;-><init>(Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mRoamingObserver:Landroid/database/ContentObserver;
...
.method private showGuideDialog(Landroid/content/Context;)V
    ...
    .line 202
    iget-object v4, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mGuideDialog:Landroid/app/AlertDialog;
    ...
    .line 204
    iput-object v7, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mGuideDialog:Landroid/app/AlertDialog;
    ...
    new-instance v6, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider$2;

    invoke-direct {v6, p0, v0, p1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider$2;-><init>(Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;Landroid/widget/CheckBox;Landroid/content/Context;)V
    ...
    iput-object v4, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mGuideDialog:Landroid/app/AlertDialog;
...
.method public onDisabled(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mRoamingObserver:Landroid/database/ContentObserver;
...
.method public onEnabled(Landroid/content/Context;)V
    ...
    iget-object v3, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->mRoamingObserver:Landroid/database/ContentObserver;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 120
    iput-object p1, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->context:Landroid/content/Context;
    ...
    invoke-static {}, Lcom/android/OriginalSettings/Utils;->isRoamingArea()Z
    ...
    .line 130
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->shouldShowGuideDialog(Landroid/content/Context;)Z
    ...
    .line 132
    invoke-direct {p0, p1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->showGuideDialog(Landroid/content/Context;)V

    goto :goto_0

    .line 135
    :cond_2
    invoke-virtual {p0}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->toggleValue()V
    ...
    .line 137
    invoke-virtual {p0, p1, v3}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->updateView(Landroid/content/Context;I)V
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->updateView(Landroid/content/Context;I)V
...
.method public toggleValue()V
    ...
    .line 88
    iget-object v4, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->context:Landroid/content/Context;
    ...
    .line 99
    iget-object v2, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->context:Landroid/content/Context;
    ...
    .line 105
    :cond_2
    iget-object v3, p0, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->context:Landroid/content/Context;
...
.method updateView(Landroid/content/Context;I)V
    ...
    .line 172
    invoke-virtual {p0, v1}, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->updateToggleButton(Landroid/widget/RemoteViews;)V
    ...
    sget-object v3, Lcom/android/OriginalSettings/widget/SmartNetworkWidgetProvider;->THIS_APPWIDGET:Landroid/content/ComponentName;
