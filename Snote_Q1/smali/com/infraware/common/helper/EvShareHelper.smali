...
.method public static sharePdf(Landroid/app/Activity;Ljava/lang/String;Ljava/util/ArrayList;)V
    .locals 7
    .parameter "a_oActivity"
    .parameter "szFilePath"
    .parameter
    ...
    .prologue
    .line 415
    .local p2, a_oAudioUriList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/Uri;>;"
    new-instance v3, Landroid/content/Intent;

    invoke-direct {v3}, Landroid/content/Intent;-><init>()V

    .line 416
    .local v3, oSendIntent:Landroid/content/Intent;
    const-string v6, "application/x-pdf"
    ...
    .line 423
    .local v0, attachmentUris:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/Uri;>;"
    invoke-virtual {v0, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    ...
    .line 432
    .end local v0           #attachmentUris:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/net/Uri;>;"
    :goto_0
    const v6, 0x7f0e008e
    ...
    .line 435
    .restart local v5       #wrapperIntent:Landroid/content/Intent;
    :catch_0
    move-exception v1
