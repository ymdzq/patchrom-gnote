...
.field private static m_bStartActivityLock:Z

.field private static m_oHelper:Lcom/infraware/note/UxInboundSaveHelper;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bStartActivityLock:Z
...
.method public constructor <init>()V
    ...
    .line 68
    iput v1, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nStartType:I
...
.method static synthetic access$1(Lcom/infraware/note/UxInboundSaveHelper;)V
    .locals 0
    .parameter

    .prologue
    .line 106
    sput-object p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oHelper:Lcom/infraware/note/UxInboundSaveHelper;

    return-void
.end method

.method static synthetic access$2(Lcom/infraware/note/UxInboundLauncherActivity;)Landroid/app/ProgressDialog;
    .locals 1
    .parameter
...
.method static synthetic access$3(Lcom/infraware/note/UxInboundLauncherActivity;Landroid/app/ProgressDialog;)V
    .locals 0
    .parameter
    .parameter
...
.method static synthetic access$4(Lcom/infraware/note/UxInboundLauncherActivity;)V
    .locals 0
    .parameter
...
.method static synthetic access$5()Lcom/infraware/note/UxInboundSaveHelper;
    .locals 1

    .prologue
    .line 106
    sget-object v0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oHelper:Lcom/infraware/note/UxInboundSaveHelper;

    return-object v0
.end method

.method static synthetic access$6(Lcom/infraware/note/UxInboundLauncherActivity;)Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;
    .locals 1
    .parameter
...
.method static synthetic access$8(Z)V
    ...
    .prologue
    .line 107
    sput-boolean p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bStartActivityLock:Z
...
.method private openIntent()V
    ...
    const-class v8, Lcom/infraware/note/UxNoteActivity;

    invoke-direct {v7, p0, v8}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    iput-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;

    .line 380
    iget-boolean v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bNewFileWithActionSend:Z
    ...
    const-class v8, Lcom/infraware/filemanager/FmFileTreeListActivity;
    ...
    .line 385
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;

    const-string v8, "receive_send_intent"
    ...
    const-string v9, "/storage/sdcard0/S Note/"
    ...
    const-string v8, "filemanager_mode"

    iget-boolean v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bNewFileWithActionSend:Z

    invoke-virtual {v7, v8, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    .line 394
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_eReceivedMimetype:Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;

    sget-object v8, Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;->Image:Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;

    if-ne v7, v8, :cond_3

    .line 395
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oReceivedUri:Landroid/net/Uri;
    ...
    const-string v8, "received_send_uri"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oReceivedUri:Landroid/net/Uri;
    ...
    .line 399
    :cond_0
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szReceivedText:Ljava/lang/String;
    ...
    const-string v8, "received_send_text"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szReceivedText:Ljava/lang/String;
    ...
    const-string v8, "minimode"

    iget-boolean v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bMinimode:Z

    invoke-virtual {v7, v8, v9}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    .line 532
    iget-boolean v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bScrapbook:Z
    ...
    const-string v8, "scrapbook"

    iget-boolean v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bScrapbook:Z
    ...
    iget v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nStartPageIndex:I
    ...
    .line 541
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->LOG_TAG:Ljava/lang/String;

    const-string v8, "openIntent"
    ...
    invoke-virtual {p0, v7}, Lcom/infraware/note/UxInboundLauncherActivity;->startActivity(Landroid/content/Intent;)V
    ...
    sget-object v8, Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;->Text:Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;

    if-ne v7, v8, :cond_6

    .line 404
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oSendTextType:Lcom/infraware/note/UxInboundLauncherActivity$SendTextType;

    if-eqz v7, :cond_4

    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oSendTextType:Lcom/infraware/note/UxInboundLauncherActivity$SendTextType;

    sget-object v8, Lcom/infraware/note/UxInboundLauncherActivity$SendTextType;->FILE:Lcom/infraware/note/UxInboundLauncherActivity$SendTextType;
    ...
    .line 408
    invoke-virtual {p0, v3}, Lcom/infraware/note/UxInboundLauncherActivity;->startActivity(Landroid/content/Intent;)V
    ...
    :cond_4
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szReceivedTitle:Ljava/lang/String;
    ...
    const-string v8, "received_send_title"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szReceivedTitle:Ljava/lang/String;
    ...
    sget-object v8, Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;->Video:Lcom/infraware/note/UxInboundLauncherActivity$ReceivedActionMimeType;
    ...
    const-string v8, "received_send_video_uri"
    ...
    .line 425
    :cond_7
    iget-boolean v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_bNewNote:Z

    if-eqz v7, :cond_9

    .line 427
    iget v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nStartType:I

    sget-object v8, Lcom/infraware/widget/SNoteDirectWidgetProvider$DirectType;->SEARCH:Lcom/infraware/widget/SNoteDirectWidgetProvider$DirectType;

    invoke-virtual {v8}, Lcom/infraware/widget/SNoteDirectWidgetProvider$DirectType;->ordinal()I
    ...
    iget v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nStartType:I
    ...
    iget v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nTemplateType:I
    ...
    const-string v8, "from_widget"

    iget-boolean v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->mIsWidget:Z
    ...
    .line 441
    :cond_9
    iget-boolean v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_isFacebook:Z
    ...
    const-string v8, "FacebookMode"

    iget-boolean v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_isFacebook:Z
    ...
    const-string v8, "FacebookFriendId"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szFacebookOwnerId:Ljava/lang/String;
    ...
    const-string v8, "FacebookFriendName"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szFacebookOwnerName:Ljava/lang/String;
    ...
    .line 473
    .end local v5           #oTemplateType:I
    :cond_a
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;

    const-string v8, "file_type"

    iget v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nFileType:I
    ...
    .line 480
    .local v6, szRealPath:Ljava/lang/String;
    :try_start_0
    ...
    .line 487
    iput-object v6, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szFileNameToOpen:Ljava/lang/String;

    .line 491
    .end local v1           #oFile:Ljava/io/File;
    .end local v6           #szRealPath:Ljava/lang/String;
    :cond_b
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;

    const-string v8, "key_filename"

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szFileNameToOpen:Ljava/lang/String;
    ...
    .line 495
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_sStartPageName:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_sStartPageName:Ljava/lang/String;
    ...
    .line 499
    .local v4, oSnoteProperty:Lcom/infraware/evengine/EV$SNOTE_PROPERTY;
    invoke-static {}, Lcom/infraware/evengine/ICoEngineInterface;->getInterface()Lcom/infraware/evengine/ICoEngineInterface;
    ...
    invoke-virtual {v7, v8, v4}, Lcom/infraware/evengine/ICoEngineInterface;->IGetSNBProperty(Ljava/lang/String;Lcom/infraware/evengine/EV$SNOTE_PROPERTY;)I

    .line 502
    iget v5, v4, Lcom/infraware/evengine/EV$SNOTE_PROPERTY;->nTemplateInfo:I

    .line 503
    .restart local v5       #oTemplateType:I
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;
    ...
    .line 505
    iget-boolean v7, v4, Lcom/infraware/evengine/EV$SNOTE_PROPERTY;->bLock:Z
    ...
    .line 509
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oShortcutInsertPasswordDialog:Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;
    ...
    invoke-virtual {v7, v12}, Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;->show(Z)V

    .line 512
    const/4 v7, 0x0

    iput-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oShortcutInsertPasswordDialog:Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;

    .line 515
    :cond_d
    new-instance v7, Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;

    sget-object v8, Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;->eUC_LockFile_Open:Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;

    iget-object v9, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_szFileNameToOpen:Ljava/lang/String;

    invoke-direct {v7, p0, v8, v9}, Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;-><init>(Landroid/app/Activity;Lcom/infraware/uxcontrol/uiunit/UiEnum$EUnitCommand;Ljava/lang/String;)V
    ...
    invoke-virtual {v7}, Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;->createView()V

    .line 517
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oShortcutInsertPasswordDialog:Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;

    invoke-virtual {v7, p0}, Lcom/infraware/uxcontrol/uicontrol/UiInsertPasswordDialog;->registerCommandListener(Lcom/infraware/uxcontrol/uiunit/UiUnitView$OnCommandListener;)V
    ...
    new-instance v7, Lcom/infraware/note/UxInboundLauncherActivity$4;

    invoke-direct {v7, p0}, Lcom/infraware/note/UxInboundLauncherActivity$4;-><init>(Lcom/infraware/note/UxInboundLauncherActivity;)V
    ...
    .end local v4           #oSnoteProperty:Lcom/infraware/evengine/EV$SNOTE_PROPERTY;
    .end local v5           #oTemplateType:I
    .restart local v1       #oFile:Ljava/io/File;
    .restart local v6       #szRealPath:Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    .end local v1           #oFile:Ljava/io/File;
    .end local v6           #szRealPath:Ljava/lang/String;
    .restart local v4       #oSnoteProperty:Lcom/infraware/evengine/EV$SNOTE_PROPERTY;
    .restart local v5       #oTemplateType:I
    :cond_e
    iget-object v7, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_oLaunchIntent:Landroid/content/Intent;
...
.method private parseNewNoteIntent(Landroid/content/Intent;)Z
    ...
    iput v0, p0, Lcom/infraware/note/UxInboundLauncherActivity;->m_nStartType:I
...
.method private parseShortcutIntent(Landroid/content/Intent;)Z
    ...
    .line 576
    invoke-direct {p0, v4}, Lcom/infraware/note/UxInboundLauncherActivity;->showAlertDialog(I)V
...
.method private showAlertDialog(I)V
    ...
    new-instance v4, Lcom/infraware/note/UxInboundLauncherActivity$5;

    invoke-direct {v4, p0}, Lcom/infraware/note/UxInboundLauncherActivity$5;-><init>(Lcom/infraware/note/UxInboundLauncherActivity;)V
    ...
    new-instance v2, Lcom/infraware/note/UxInboundLauncherActivity$6;

    invoke-direct {v2, p0}, Lcom/infraware/note/UxInboundLauncherActivity$6;-><init>(Lcom/infraware/note/UxInboundLauncherActivity;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 128
    sget-object v2, Lcom/infraware/note/UxInboundLauncherActivity;->m_oHelper:Lcom/infraware/note/UxInboundSaveHelper;
...
.method public startActivity(Landroid/content/Intent;)V
    ...
    .prologue
    .line 890
    sget-boolean v1, Lcom/infraware/note/UxInboundLauncherActivity;->m_bStartActivityLock:Z
    ...
    sput-boolean v1, Lcom/infraware/note/UxInboundLauncherActivity;->m_bStartActivityLock:Z
    ...
    new-instance v1, Lcom/infraware/note/UxInboundLauncherActivity$7;

    invoke-direct {v1, p0}, Lcom/infraware/note/UxInboundLauncherActivity$7;-><init>(Lcom/infraware/note/UxInboundLauncherActivity;)V
